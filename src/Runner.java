...
public class Runner extends JFrame implements Observable
{
    ...
    public Runner() throws IOException
    {
        ...
        mPane = new MandelbrotControl();
        mPane.setSize(ImageWidth, ImageHeight);
        mPane.setLocation(0, 0);

        tPane = new ToolBar(ImageWidth, 220, mPane, this, true);
    ...
    public void update()
    {
        ...
        if(docked)
        {
            ...
            tbd.add(tPane);
            this.remove(tPane);
            this.setSize(mPane.getImgW(), mPane.getImgH()+this.getInsets().top+this.getInsets().bottom);
        ...
        else
        {
            ...
            this.add(tPane);
            this.setSize(mPane.getImgW(), mPane.getImgH()+210);
            this.setPreferredSize(this.getSize());
